...
contract("Colony Network", accounts => {
  ...
  describe("when initialised", () => {
    ...
    it("should not be able to create a colony if the network is not initialised", async () => {
      ...
      await checkErrorRevert(
        colonyNetwork.createColony("0x8972e86549bb8E350673e0562fba9a4889d01637", 0, "", "", false),
  ...
  describe("when creating new colonies at a specific version", () => {
    ...
    it("should not users to create a new colony at a version that doesn't exist", async () => {
      ...
      await checkErrorRevert(colonyNetwork.createColony(token.address, 0, "", "", false), "colony-network-invalid-version");
    });
  });
  ...
  describe("when creating new colonies", () => {
    ...
    it("should fail if ETH is sent", async () => {
      const token = await Token.new(...TOKEN_ARGS);
      await checkErrorRevert(colonyNetwork.createColony(token.address, 0, "", "", false, { value: 1, gas: createColonyGas }));
